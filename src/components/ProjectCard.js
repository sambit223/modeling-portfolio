    ...
    <div className="mt-10">
      ...
      <div className="flex flex-col items-center justify-center p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Project 1 */}
          <div className="relative group overflow-hidden rounded-lg shadow-lg p-1">
            <img
              src={image1}
            ...
            <h3 className="text-center text-lg font-semibold mt-2 text-gray-800">
              Designer: Bastra V | Role: Showstopper
            </h3>
          </div>
          ...
          <div className="relative group overflow-hidden rounded-lg shadow-lg p-1">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-700 ease-in-out">
            <p className="text-white text-lg px-6 text-center">
                Representing <strong>Crass</strong> on the runway, showcasing their stunning casual indo western collection.
              </p>
            </div>
            <h3 className="text-center text-lg font-semibold mt-2 text-gray-800">
              Designer: Crass V | Role: Lead Model
            </h3>
          </div>
          ...
          <div className="relative group overflow-hidden rounded-lg shadow-lg p-1">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-700 ease-in-out">
              <p className="text-white text-lg px-6 text-center">
                Collaborated with <strong>Swaah</strong>, representing exclusive designer black indo-westren lehenga on the runway.
              </p>
            </div>
            <h3 className="text-center text-lg font-semibold mt-2 text-gray-800">
